    ...
    <div>
      <div
        className={`${
          ...
          isOpen ? "bg-primary" : scrolled ? "bg-primary" : "bg-transparent"
        }`}
      >
        <div className="w-full flex items-center justify-between">
          ...
          <div className="hidden lg:block ml-10 flex items-baseline space-x-4">
            ...
            >
              Resume <i class="fa-regular fa-paper-plane ml-1"></i>
            </a>
          </div>
        </div>
      ...
      >
        {(ref) => (
          <div
            className="lg:hidden border-b-2 rounded-b-xl border-white"
            id="mobile-menu"
          >
